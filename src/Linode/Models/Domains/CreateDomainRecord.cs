...
public record CreateDomainRecord
{
    ...
    /// preferred. Only valid for <see cref="DomainRecordType.MX"/> and
    /// <see cref="DomainRecordType.SRV"/> record requests. Required for
    /// <see cref="DomainRecordType.SRV"/> record requests.
    /// <para/>
    /// Defaults to 0 for <see cref="DomainRecordType.MX"/> record requests.
    /// Must be 0 for Null <see cref="DomainRecordType.MX"/> records.
    /// </summary>
    ...
    /// valid and required for <see cref="DomainRecordType.CAA"/> record requests.
    /// </summary>
    ...
    /// <summary>
    /// The type of Record this is in the DNS system. For example,
    /// <see cref="DomainRecordType.A"/> records associate a domain name with
    /// an IPv4 address, and <see cref="DomainRecordType.AAAA"/> records
